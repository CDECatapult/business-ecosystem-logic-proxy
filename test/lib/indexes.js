...
describe("Test index helper library", function () {
    ...
    it('should reject promise when the offering specified in a product is not indexed', function (done) {
        ...
        var errMsg = 'The offering 5 specified in the product is not indexed{"id":12,"productOffering":{"id":5,"href":"http://myserver.com/catalog/offering/5"},"relatedParty":[{"id":"rock","role":"customer"}],"href":"http://12","name":"inventoryName","status":"status","startDate":"2017-06-01","orderDate":232323231,"searchable":["offername2","description2"]}';
